...
<body>
	...
	// 삽니다의 경우
	 ArrayList buyList = bdao.getSellList(startRow, pageSize);
		...
		if(cnt != 0){
			...
			%>
			    ...
			    <%if(startPage > pageBlock){ %>
			     ...
			     href="/Portpolio_camp/board/SellForm.jsp?pageNum=<%=startPage-pageBlock%>"
			...
			%>
			    <li class="page-item"><a class="page-link" href="/Portpolio_camp/board/SellForm.jsp?pageNum=<%=i %>"><%=i %></a></li>
			<%
			}
