			...
			if(cnt != 0){
				...
				%>
				    ...
				    <%if(startPage > pageBlock){ %>
				     ...
				     href="/Portpolio_camp/board/marketForm.jsp?pageNum=<%=startPage-pageBlock%>"
				...
				%>
				    <li class="page-item"><a class="page-link" href="/Portpolio_camp/board/marketForm.jsp?pageNum=<%=i %>"><%=i %></a></li>
				<%
				}
