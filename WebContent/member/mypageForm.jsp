...
<div class="row pt-5">
	<div class="col-3">
		...
		<div class="card container" style="width: 20rem; height: 500px;">
		  <img src="../img/mypage/myuser.png" class="card-img-top my-5" alt="..." height="120">
		  <div class="card-body text-center my-5">
		    <h5 class="card-title">내정보</h5>
		    <p class="card-text">가입 시 입력한 회원정보를 조회 합니다.</p>
		    <a href="/Portpolio_camp/member/myinfopreForm.jsp" class="btn btn-primary">이동하기</a>
		  </div>
		</div>
		<!-- 카드 종료 -->		
	...
	<div class="col-3">	
		<!-- 카드 시작 -->		
		<div class="card container" style="width: 20rem; height: 500px;">
		  <img src="/Portpolio_camp/img/mypage/information.png" class="card-img-top my-5" alt="..." height="120px">
		  <div class="card-body text-center my-5">
		    <h5 class="card-title">내정보 관리</h5>
		    <p class="card-text">가입 시 입력한 회원정보를 수정 합니다.</p>
		    <a href="/Portpolio_camp/member/manageForm.jsp?id=<%=id %>" class="btn btn-primary">이동하기</a>
		  </div>
		</div>
		<!-- 카드 종료 -->	
	</div>
	<div class="col-3">	
		<!-- 카드 시작 -->		
		<div class="card container" style="width: 20rem; height: 500px;"> 
		  <img src="/Portpolio_camp/img/mypage/favorite.png" class="card-img-top my-5" alt="..." height="130px">
		  <div class="card-body text-center my-5">
	...
	<div class="col-3">	
		<!-- 카드 시작 -->		
		<div class="card container" style="width: 20rem; height: 500px;">
		  <img src="/Portpolio_camp/img/mypage/delete.png" class="card-img-top my-5" alt="..." height="130px">
		  <div class="card-body text-center my-5">
