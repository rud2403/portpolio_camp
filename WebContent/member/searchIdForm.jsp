...
<div class="container-md">
 ...
 <!-- 텍스트 row 시작 -->
  <div class="row">
 	...
 	<div class="text-center">가입하신 이메일과 성함으로 아이디를 찾을 수 있습니다.</div>
 </div>
 <!-- 텍스트 row 끝 -->
 ...
 <div class="col-3"></div>
  <div class="col-6">
   ...
   <div class="form-floating">
    <input type="password" class="form-control" id="floatingPassword" placeholder="Email" name="Email">
 ...
 <!-- 이름, 이메일 input 끝 -->
  ...
  <!-- 제출 버튼 시작 -->   
   <div class="col-sm30 p-5" style="text-align:center;">
    <input class="btn btn-primary btn-block" type="submit" value="아이디 찾기" onclick="return check1()">
   </div>
  <!-- 제출 버튼 끝 -->
